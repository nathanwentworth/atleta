...
public class dialogue : MonoBehaviour {
	...
	public AudioSource pageflip1;
	public AudioSource pageflip2;
  ...
  void Start() {
	...
	void PlayPageSound(){
		float randomSound = Random.Range (0, 2);
		if (randomSound == 0) {
			pageflip1.Play ();
	...
	public void Instructions(){
		dialogueText.text = "Are you playing with an Xbox Controller or Keyboard and Mouse?";
		...
		ans1text.text = "Xbox Controller";
		ans2text.text = "Keyboard and Mouse";
		// ans3text.text = " ";
	}
